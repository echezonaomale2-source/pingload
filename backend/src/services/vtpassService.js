...
const VTPASS_ERROR_MESSAGES = {
  ...
  '030': 'Duplicate request ID ΓÇö transaction may already exist',
 ...
 * Never throws ΓÇö returns a structured status for logging.
 */
const verifyVtpassConnectivity = async () => {
  ...
  try {
    ...
    // Optional ΓÇö IP lookup failure should not block startup.
  }
